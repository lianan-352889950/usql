...
require (
	...
	github.com/apache/arrow/go/arrow v0.0.0-20201204230548-63144ad25ab0 // indirect
	github.com/apache/calcite-avatica-go/v5 v5.0.0
	github.com/couchbase/go-couchbase v0.0.0-20201112235918-f07aeb6115a6 // indirect
